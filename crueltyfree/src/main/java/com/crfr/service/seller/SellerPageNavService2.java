...
@Service("sPageNavSet2")
public class SellerPageNavService2 implements ProductSellerService {
	
	public PageNav setSellerPageNav2(PageNav pageNav, String pageNum, String pageBlock, int member_idx) {
