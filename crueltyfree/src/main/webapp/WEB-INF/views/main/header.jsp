	...
	<c:choose>
		<c:when test="${!empty member and member.member_grade ==  2}">
			...
			<article class="small_menu">
				<a><span class="blueText">${member.member_nickname}</span>님</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/manager/manager_1main.do">관리자페이지</a>&nbsp;<span class="verticalBar">|</span>&nbsp;<a href="${pageContext.request.contextPath}/member/logout.do">로그아웃</a>&nbsp;<span class="verticalBar">|</span>&nbsp;<a href="${pageContext.request.contextPath}/mypage/mypage_main.do">마이페이지</a>&nbsp;<span class="verticalBar">|</span>&nbsp;<span class="basket_move">장바구니</span>&nbsp;<span class="verticalBar">|</span>&nbsp;<a href="${pageContext.request.contextPath}/mypage/mypage_orderinq.do">주문배송</a>&nbsp;<span class="verticalBar">|</span>&nbsp;<a href="${pageContext.request.contextPath}/one_inq/notice.do">고객센터</a>
			</article>
		</c:when>
		<c:when test="${!empty member and member.member_grade ==  1}">			
			<!-- 판매자용:회원등급1 -->			
			<article class="small_menu">
				<a><span class="blueText">${member.member_nickname}</span>님</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/seller/check_pro.do">판매자페이지</a>&nbsp;<span class="verticalBar">|</span>&nbsp;<a href="${pageContext.request.contextPath}/member/logout.do">로그아웃</a>&nbsp;<span class="verticalBar">|</span>&nbsp;<a href="${pageContext.request.contextPath}/mypage/mypage_main.do">마이페이지</a>&nbsp;<span class="verticalBar">|</span>&nbsp;<span class="basket_move">장바구니</span>&nbsp;<span class="verticalBar">|</span>&nbsp;<a href="${pageContext.request.contextPath}/mypage/mypage_orderinq.do">주문배송</a>&nbsp;<span class="verticalBar">|</span>&nbsp;<a href="${pageContext.request.contextPath}/one_inq/notice.do">고객센터</a>
			</article>
		</c:when>		
		<c:when test="${!empty member}">
			<!-- 회원용:로그인 -->
			<article class="small_menu">
				<a><span class="blueText">${member.member_nickname}</span>님</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/member/logout.do">로그아웃</a>&nbsp;<span class="verticalBar">|</span>&nbsp;<a href="${pageContext.request.contextPath}/mypage/mypage_main.do">마이페이지</a>&nbsp;<span class="verticalBar">|</span>&nbsp;<span class="basket_move">장바구니</span>&nbsp;<span class="verticalBar">|</span>&nbsp;<a href="${pageContext.request.contextPath}/mypage/mypage_orderinq.do">주문배송</a>&nbsp;<span class="verticalBar">|</span>&nbsp;<a href="${pageContext.request.contextPath}/one_inq/notice.do">고객센터</a>
			</article>
		</c:when>
		<c:otherwise>
			<!-- 일반용 -->
			<article class="small_menu">
				<a href="${pageContext.request.contextPath}/member/terms.do">회원가입</a>&nbsp;<span class="verticalBar">|</span>&nbsp;<a href="${pageContext.request.contextPath}/member/login.do">로그인</a>&nbsp;<span class="verticalBar">|</span>&nbsp;<span class="basket_move">장바구니</span>&nbsp;<span class="verticalBar">|</span>&nbsp;<a href="${pageContext.request.contextPath}/mypage/mypage_orderinq.do">주문배송</a>&nbsp;<span class="verticalBar">|</span>&nbsp;<a href="${pageContext.request.contextPath}/one_inq/notice.do">고객센터</a>
			</article>
		</c:otherwise>
	</c:choose>
	...
	<div class="recent_pro">
		...
		<div class="recent_box">
			...
			<div class="recent_item">
				...
				<fmt:formatNumber value="${RecentViewList[itemRow-1].product_price}" pattern="###,###" />원
				</div>								
			</div>
			</c:forEach>			
			</div>
