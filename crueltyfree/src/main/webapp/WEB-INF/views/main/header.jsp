...
<div class="head">
	...
	<c:choose>
		...
		<c:otherwise>
			<!-- 일반용 -->
			<article class="small_menu">
				<a href="${pageContext.request.contextPath}/member/terms.do">회원가입</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/member/login.do">로그인</a>&nbsp;&nbsp;<span class="basket_move">장바구니</span>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/mypage/mypage_orderinq.do">주문배송</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/one_inq/notice.do">고객센터</a>
			</article>
		</c:otherwise>
	</c:choose>
