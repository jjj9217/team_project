...
<head>
<meta charset="UTF-8">
<title>회원가입 이용약관 | CrueltyFree</title>
<style>
	* {margin:0; padding:0;}
...
//필수동의 체크 여부를 확인한 뒤 버튼을 활성화 , 비활성화 동작 함수
	// 모든 체크박스 상태를 확인
    const agreeTerms1 = document.getElementById("chkAll").checked;
    const agreeTerms2 = document.getElementById("chk").checked;
    const agreeTerms3 = document.getElementById("chk").checked;
    // 모든 이용약관에 동의했는지 확인
    if (agreeTerms1 && agreeTerms2 && agreeTerms3) {
        // 여기에 회원가입 페이지로 이동하는 코드를 추
        window.location.href="join.do"
        // window.location.href = "회원가입 페이지 URL";
    } else {
        alert("모든 이용약관에 동의해야 회원가입이 가능합니다.");
    }
}
...
<header>
	...
	<div id="joinbanner" style="text-align:center; margin: 0 auto; width:1000px; height:90px; margin-top:70px;"><img src="../resources/img/joinbanner.JPG" style="width: 500px; height: 90px; text-align:center; margin:0 auto; "></div>
    <div id="yak">
    	 <div id="logo">회원가입약관</div>
    	
    	<div id="fregister_chkall">
        <label for="chkAll" style="font: bold 17px Arial, Sans-serif;">필수 약관 전체 동의</label>
        <input type="checkbox" id="chkAll">
        
    </div>
    <br>
     
     <div id="text1"><br>&nbsp;크루얼티프리 서비스 이용약관 동의(필수)</div>
...
제24조(재판권 및 준거법)
 ...
 <div id="fregister_chkall">
        <label><span>이용약관 동의</span><span style="color:red;">(필수)</span>
        <input type="checkbox" name="chk"  id="chk" class="chk"></label></div>
 <br><br><br>
 <div id="text1"><br>&nbsp;개인정보 수집 및 이용 동의(필수)</div>
 <textarea readonly>
 개인정보보호법에 따라 CrueltyFree에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.

1. 수집하는 개인정보
이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 CrueltyFree 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, CrueltyFree는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.

회원가입 시점에 CrueltyFree가 이용자로부터 수집하는 개인정보는 아래와 같습니다.
...
- CrueltyFree 내의 개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서 해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다. 추가로 개인정보를 수집할 경우에는 해당 개인정보 수집 시점에서 이용자에게 ‘수집하는 개인정보 항목, 개인정보의 수집 및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고 동의를 받습니다.
...
CrueltyFree에서 제공하는 위치기반 서비스에 대해서는 'CrueltyFree 위치기반서비스 이용약관'에서 자세하게 규정하고 있습니다.
이와 같이 수집된 정보는 개인정보와의 연계 여부 등에 따라 개인정보에 해당할 수 있고, 개인정보에 해당하지 않을 수도 있습니다.
2. 수집한 개인정보의 이용
CrueltyFree 및 CrueltyFree 관련 제반 서비스(모바일 웹/앱 포함)의 회원관리, 서비스 개발・제공 및 향상, 안전한 인터넷 이용환경 구축 등 아래의 목적으로만 개인정보를 이용합니다.

- 회원 가입 의사의 확인, 연령 확인 및 법정대리인 동의 진행, 이용자 및 법정대리인의 본인 확인, 이용자 식별, 회원탈퇴 의사의 확인 등 회원관리를 위하여 개인정보를 이용합니다.
- 콘텐츠 등 기존 서비스 제공(광고 포함)에 더하여, 인구통계학적 분석, 서비스 방문 및 이용기록의 분석, 개인정보 및 관심에 기반한 이용자간 관계의 형성, 지인 및 관심사 등에 기반한 맞춤형 서비스 제공 등 신규 서비스 요소의 발굴 및 기존 서비스 개선 등을 위하여 개인정보를 이용합니다.
- 법령 및 CrueltyFree 이용약관을 위반하는 회원에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한 방지 및 제재, 계정도용 및 부정거래 방지, 약관 개정 등의 고지사항 전달, 분쟁조정을 위한 기록 보존, 민원처리 등 이용자 보호 및 서비스 운영을 위하여 개인정보를 이용합니다.
...
- CrueltyFree 플러스 멤버십 서비스 혜택 중복 제공 방지
...
전자상거래 등에서의 소비자 보호에 관한 법률, 전자문서 및 전자거래 기본법, 통신비밀보호법 등 법령에서 일정기간 정보의 보관을 규정하는 경우는 아래와 같습니다. CrueltyFree는 이 기간 동안 법령의 규정에 따라 개인정보를 보관하며, 본 정보를 다른 목적으로는 절대 이용하지 않습니다.
...
참고로 CrueltyFree는 ‘개인정보 유효기간제’에 따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 별도로 분리 보관하여 관리하고 있습니다.

4. 개인정보 수집 및 이용 동의를 거부할 권리
이용자는 개인정보의 수집 및 이용 동의를 거부할 권리가 있습니다. 회원가입 시 수집하는 최소한의 개인정보, 즉, 필수 항목에 대한 수집 및 이용 동의를 거부하실 경우, 회원가입이 어려울 수 있습니다.
 </textarea>
 	<div id="fregister_chkall">
        <label><span>개인정보 수집,이용 동의</span><span style="color: red;">(필수)</span>
        <input type="checkbox" name="chk" id="chk" class="chk"></label>
    </div>
    <input type="button" id="reset_btn" value="취 소" onclick="location.href='login.jsp';">
    <input type="button" id="join_btn" value="다 음" onclick="checkAgreements()" >
</div>    
