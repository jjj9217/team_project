...
<form name="caq" action="${pageContext.request.contextPath}/mypage/mypage_deliveryreg_write_process.do" method="post">
        <table class="address_list" >
            ...
            <tbody>
                <tr>
                    <th>배송지명</th>
                    <td><input type="text" name="delivery_address_name" id="input" placeholder="최대 10자"><input type="checkbox" id="defaultpostcheck" value="1" name="defaultpost"><input type="hidden" name="defaultpost" value="0" id="defaultpostcheck_hidden"/><label for="defaultpostcheck"> 기본 배송지 설정</label>
                    </td>
                </tr>           
                <tr>
                    <th>받는분</th>
