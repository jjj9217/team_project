        ...
        <table class="buy_list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <a href="${pageContext.request.contextPath}/product/product_view.do?prdNum=${likeproductList[rowNum-1].product_idx}" class="goodlist">${likeproductList[rowNum-1].product_name}</a></td>
