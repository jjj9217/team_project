        ...
        <table class="buy_list">
            ...
            <tbody>
                    ...
                    <!-- c:if nonreviewfileList[rowNum-1]. = null이면 리뷰안쓴목록만 출력하는방식도 있을 듯? -->
                            <c:if test="${!empty reviewfileList[rowNum-1].saveFile}">
                <tr>                
                    <td>${reviewfileList[rowNum-1].saveFile}상품사진</td>
                    <td>${reviewproductList[rowNum-1].order_date}구매일자</td>
                    <td>${reviewproductList[rowNum-1].product_name}상품이름</td>                    
                    <td>${reviewproductList[rowNum-1].review_regDate}작성날짜</td>
                    <td>${reviewproductList[rowNum-1].review_socre}별점</td>
                    <td>${reviewproductList[rowNum-1].review_content}리뷰내용</td>
                    <td>
                        <button>리뷰 수정</button>
                        <button>리뷰 보기</button>
                </tr>
