...
<form name="notice_insert" method="post" action="noticeModify_process.do" enctype="multipart/form-data" 
	...
	<div class="notice_type">
		...
		<article class="notice_right">
			<input type="text" name="notice_title" class="regi_box" style="width:350px;" value="${noticeView.notice_title}">
		</article>
	</div>
	...
	<div class="notice_sub">
		...
		<article class="notice_right">
			<textarea name="notice_content" class="notice_content" placeholder="내용을 1000자 이내로 입력해주세요">${noticeView.notice_title}</textarea>
		</article>
	</div>
	...
	<!-- 등록 버튼 -->
	<div class="div_write">
		<input type="submit" id="notice_write" value="수정하기">
		<input type="hidden" name="notice_idx" value="${noticeView.notice_idx}">
		<a href="${pageContext.request.contextPath}/one_inq/noticeModify_process.do"><button id="notice_cancel">취소하기</button></a>
	</div>
</form>
</section>
<footer>
