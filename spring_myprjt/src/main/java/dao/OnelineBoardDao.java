...
@Repository
public class OnelineBoardDao{
	
	public static final String MAPPER = "OnelineBoardMapper";
	SqlSession sqlSession;
	
	@Autowired
	public OnelineBoardDao(SqlSession sqlSession){
		this.sqlSession = sqlSession;
	}	
		
	public int insertBoard(OnelineBoardVo vo) {
	...
	public int updateBoard(OnelineBoardVo vo) {
		return sqlSession.update(MAPPER+".updateBoard", vo);
	}
	
	public int deletePost(OnelineBoardVo vo) {
