...
@Service("fbInsertRecommendationCount")
public class FreeBoardInsertRecommendationCountService implements FreeBoardService {
	private FreeBoardDao dao;
	
	@Autowired
	public FreeBoardInsertRecommendationCountService(FreeBoardDao dao) {
		this.dao = dao;
	}
