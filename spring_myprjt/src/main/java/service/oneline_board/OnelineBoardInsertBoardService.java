...
@Service("obInsertBoard")
public class OnelineBoardInsertBoardService implements OnelineBoardService {
	private OnelineBoardDao dao;
	
	@Autowired
	public OnelineBoardInsertBoardService(OnelineBoardDao dao) {
		this.dao = dao;
	}
