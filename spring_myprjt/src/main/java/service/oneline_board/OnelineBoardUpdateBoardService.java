...
@Service("obUpdateBoard")
public class OnelineBoardUpdateBoardService implements OnelineBoardService {
	private OnelineBoardDao dao;
	
	@Autowired
	public OnelineBoardUpdateBoardService(OnelineBoardDao dao) {
		this.dao = dao;
	}
	...
	public int updateBoard(MultipartFile attachedFile,
		...
		OnelineBoardVo vo = new OnelineBoardVo();
