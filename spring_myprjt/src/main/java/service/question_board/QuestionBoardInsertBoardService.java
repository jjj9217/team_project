...
@Service("qbInsertBoard")
public class QuestionBoardInsertBoardService implements QuestionBoardService {
	private QuestionBoardDao dao;
	
	@Autowired
	public QuestionBoardInsertBoardService(QuestionBoardDao dao) {
		this.dao = dao;
	}
