...
@Service("qbDeleteReply")
public class QuestionBoardReplyDeleteReplyService implements QuestionBoardReplyService {
	private QuestionBoardReplyDao dao;
	
	@Autowired
	public QuestionBoardReplyDeleteReplyService(QuestionBoardReplyDao dao) {
		this.dao = dao;
	}
	...
	public int deleteReply(int reply_idx, HttpServletRequest request) {
		...
		QuestionBoardReplyVo vo = dao.selectReplyView(reply_idx);
