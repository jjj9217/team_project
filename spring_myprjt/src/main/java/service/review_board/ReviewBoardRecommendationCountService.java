...
@Service("rbRecommendationCount")
public class ReviewBoardRecommendationCountService implements ReviewBoardService {
	private ReviewBoardDao dao;
	
	@Autowired
	public ReviewBoardRecommendationCountService(ReviewBoardDao dao) {
		this.dao = dao;
	}
