<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="dao.FreeBoardDao, vo.FreeBoardVo" %>  
...
<head>
<meta charset="UTF-8">
<title>SkyBox - 게시글 수정 - 자유게시판</title>
...
<body>
	...
	<div id="contentcontainer">
		...
		<table id="tb_board">			
			<tr>
				<td id="td_title" colspan="3"><a href="../free_board/list.do">자유게시판</a></td>
			...
			<td class="td_space" colspan="5">
				<input type="hidden" name="member_nickname" value="${freeboardVo.member_nickname}">
                <input type="hidden" name="member_idx" value="${freeboardVo.member_idx}">
                <input type="hidden" name="board_idx" value="${freeboardVo.board_idx}">
			</td>
			</tr>
			<tr>
				<td id="td_title_input" colspan="5">
					<input type="text" id="title_input" name="title" value="${freeboardVo.title}">
				</td>
			</tr>			
			<tr><td class="td_space" colspan="5"></td></tr>				
			<tr>
				<td id="td_content" colspan="5">
					<textarea id="content_input" name="content" cols="30" rows="20">${freeboardVo.content}</textarea>
				</td>
			</tr>
			<tr><td class="td_space" colspan="5"></td></tr>
			<tr>
				<td id="td_file" colspan="5">
					...
					<c:choose>
						<c:when test="${!empty freeboardVo.saveFile}">
							<img src="../resources/uploads/${freeboardVo.saveFile}"  width="128px" height="128px"  alt="첨부파일 이미지"><br>
							<a href="download.do?oName=${freeboardVo.originFile}&sName=${freeboardVo.saveFile}">${freeboardVo.originFile}</a><br>
						</c:when>
						<c:otherwise>
							없음
						</c:otherwise>
