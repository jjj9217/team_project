...
<%@ page import="vo.FreeBoardVo, dao.FreeBoardDao" %>
	...
	<nav id="main-navigaion">
		...
		<div class="pull-right">
			<div class="search-bar">
				<form action="../main/search_list.do" method="post" name="searchfrm">
				...
				<c:otherwise>
					...
					<c:forEach var="rowNum" begin="${startNum}" end="${endNum}">
						<tr class="rowColor">
							...
							<td class="td_count">
							${boardList[rowNum-1].recommendation_count}
							</td>
			...
			<tr>
				...
				<td id="td_search" colspan="4">
				 	<c:choose>							
						<c:when test="${!empty membership}">
						<!-- 회원용 -->
				 			<a href="../free_board/write.do"><input type="button" name="write_btn" id="write_btn" value="글쓰기"></a>
						</c:when>
						<c:otherwise>	
						<!-- 일반용 -->
						</c:otherwise>
	...
	<div id="pagingcontainer">	
		<div id="pagingleft" class="pull-left">
			<table>
				<tr>
					<td id="td_paging">
						<%@ include file="../free_board/paging_list20.jsp" %>					
					</td>
				</tr>
			</table>					
		</div>
