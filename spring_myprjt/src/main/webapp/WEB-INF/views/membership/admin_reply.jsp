...
<body>
	...
	<div id="contentcontainer">
		<fieldset>
            ...
            <span id="link2"><a href="../membership/admin_content.do">작성글보기</a>&nbsp;&nbsp;</span>
            <span id="sub-title"><a href="../membership/admin_reply.do">작성댓글보기</a></span>&nbsp;&nbsp;
	            <form name="adminfrm" method="post" action="admin_reply_delete_process.do">
	            <table id="tb_board">
	                <tr>
	                    <c:set var="total" value="${totalRows}" />
	                    <td id="td_count" colspan="4">총 댓글 수: ${total}</td>
				...
				<tr class="tr_sky_color">
					<td class="td_radio">
					<input type="checkbox" name="checkbox" value="${replyList[rowNum-1].all_reply_number}">
					<input type="hidden" name="target_number" value="${replyList[rowNum-1].board_idx}">
					</td>
					...
					<td class="td_user">${replyList[rowNum-1].member_nickname}</td>		
					<td class="td_date">${replyList[rowNum-1].post_date}</td>			
				</tr>	
				</c:forEach>
				<tr><td colspan="5" class="td_space"></tr>
				</table>
	            </form>
				<table id="tb_search">					
					<tr>
						<td id="td_paging" colspan="4">
							<%@ include file="../membership/paging_admin_reply.jsp" %>
						</td>
					</tr>
					<tr>
