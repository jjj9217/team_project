...
<body>
	...
	<div id="title"  class="pull-left"><a href="../membership/search_id.do">아이디 찾기</a></div>	
	</div>
            ...
            <form action="search_id_process.do" method="post" name="frm">
	            <table>
	                ...
	                <tr>
	                    ...
	                    <td class="td_content"><input type="email" class="input_text" name="email" id="email" placeholder="이메일 주소를 입력해주세요."></td>
	                </tr>	                
	                <tr>
	                	<td id="td_submit" colspan="2"><input type="button" name="search_id_btn" id="submit_btn" value="아이디 찾기"></td>	                	
	                </tr>
	                <tr>
	                	<td id="td_bottom" colspan="2">
		                	<a href="../membership/login.do">&nbsp;&nbsp;로그인&nbsp;&nbsp;</a>
		                	<a href="../membership/search_pw.do">&nbsp;&nbsp;비밀번호 찾기&nbsp;&nbsp;</a>
