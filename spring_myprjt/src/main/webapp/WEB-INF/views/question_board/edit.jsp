<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="dao.QuestionBoardDao, vo.QuestionBoardVo" %>  
...
<head>
<meta charset="UTF-8">
<title>SkyBox - 게시글 수정 - 질문게시판</title>
...
<body>
	...
	<div id="contentcontainer">
		...
		<table id="tb_board">			
			<tr>
				<td id="td_title" colspan="3"><a href="../question_board/list.do">질문게시판</a></td>
			...
			<td class="td_space" colspan="5">
				<input type="hidden" name="member_nickname" value="${questionboardVo.member_nickname}">
                <input type="hidden" name="member_idx" value="${questionboardVo.member_idx}">
                <input type="hidden" name="board_idx" value="${questionboardVo.board_idx}">
			</td>
			</tr>
			<tr>
				<td id="td_title_input" colspan="5">
					<input type="text" id="title_input" name="title" value="${questionboardVo.title}">
				</td>
			</tr>			
			<tr><td class="td_space" colspan="5"></td></tr>				
			<tr>
				<td id="td_content" colspan="5">
					<textarea id="content_input" name="content" cols="30" rows="20">${questionboardVo.content}</textarea>
				</td>
			</tr>
			<tr><td class="td_space" colspan="5"></td></tr>
			<tr>
				<td id="td_file" colspan="5">
					...
					<c:choose>
						<c:when test="${!empty questionboardVo.saveFile}">
							<img src="../resources/uploads/${questionboardVo.saveFile}"  width="128px" height="128px"  alt="첨부파일 이미지"><br>
							<a href="download.do?oName=${questionboardVo.originFile}&sName=${questionboardVo.saveFile}">${questionboardVo.originFile}</a><br>
						</c:when>
						<c:otherwise>
							없음
						</c:otherwise>
