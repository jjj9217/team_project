...
<head>
<meta charset="UTF-8">
<title>SkyBox - 게시글 작성 - 질문게시판</title>
		...
		<table id="tb_board">			
			...
			<tr>
				<td id="td_title_input" colspan="5">
					<input type="text" id="title_input" name="title" placeholder="제목을 입력하세요.">
					<input type="hidden" name="member_nickname" value="${membership.member_nickname}">
                    <input type="hidden" name="member_idx" value="${membership.member_idx}">
				</td>
			</tr>			
			<tr><td class="td_space" colspan="5"></td></tr>			
			<tr>
				<td id="td_content" colspan="5">
					<textarea id="content_input" name="content" cols="30" rows="20" placeholder="내용을 입력하세요."></textarea>
				</td>
			</tr>
			<tr><td class="td_space" colspan="5"></td></tr>
			<tr>
				<td id="td_file" colspan="5">
					<input type="file" id="file_input" name="attachedFile">
					 <br><span id="file_notice">5MB 이하의 파일을 첨부해주세요.</span>
				</td>
			</tr>
