...
<body>
	...
	<div id="contentcontainer">
		...
		<table id="tb_board">			
			<tr>
				<td id="td_title" colspan="3"><a href="../review_board/list.do">리뷰</a></td>
			...
			<td class="td_space" colspan="5">
				<input type="hidden" name="member_nickname" value="${reviewboardVo.member_nickname}">
                <input type="hidden" name="member_idx" value="${reviewboardVo.member_idx}">
                <input type="hidden" name="board_idx" value="${reviewboardVo.board_idx}">
			</td>
			</tr>
			<tr>
				<td id="td_title_input" colspan="5">
					<input type="text" id="title_input" name="title" value="${reviewboardVo.title}">
				</td>
			</tr>			
			<tr><td class="td_space" colspan="5"></td></tr>				
			<tr>
				<td id="td_content" colspan="5">
					<textarea id="content_input" name="content" cols="30" rows="20">${reviewboardVo.content}</textarea>
				</td>
			</tr>
			<tr><td class="td_space" colspan="5"></td></tr>
			<tr>
				<td id="td_file" colspan="5">
					...
					<c:choose>
						<c:when test="${!empty reviewboardVo.saveFile}">
							<img src="../resources/uploads/${reviewboardVo.saveFile}"  width="128px" height="128px"  alt="첨부파일 이미지"><br>
							<a href="download.do?oName=${reviewboardVo.originFile}&sName=${reviewboardVo.saveFile}">${reviewboardVo.originFile}</a><br>
						</c:when>
						<c:otherwise>
							없음
						</c:otherwise>
