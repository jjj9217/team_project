...
<body>
	...
	<div id="contentcontainer">
		<table id="tb_board">			
			<tr>
				<td id="td_title" colspan="2"><a href="../review_board/list.js">리뷰</a></td>
			...
			<tr>
				...
				<td id="td_search" colspan="4">
				 	<c:choose>							
						<c:when test="${!empty membership}">
						<!-- 회원용 -->
				 			<a href="../review_board/write.do"><input type="button" name="write_btn" id="write_btn" value="글쓰기"></a>
						</c:when>
						<c:otherwise>	
						<!-- 일반용 -->
						</c:otherwise>
	...
	<div id="pagingcontainer">	
		<div id="pagingleft" class="pull-left">
			<table>
				<tr>
					<td id="td_paging">
						<%@ include file="../review_board/paging_list20.jsp" %>					
					</td>
				</tr>
			</table>					
		</div>
